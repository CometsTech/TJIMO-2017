...
&\text{Exactly two of these statements is false.} \\
&\text{Exactly three of these statements is false.} \\
&\text{Exactly four of these statements is false.} \\
&\text{Exactly five of these statements is false.} 
\end{aligned}
}
\end{center}
\end{problem}
