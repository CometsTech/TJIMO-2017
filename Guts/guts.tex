...
\begin{problem}
If the radius of the larger circle is $6$, and all the smaller circles are the same size, then what is the side length of the hexagon?
    \begin{center}
...
\begin{problem}
Let $ABCD$ and $EFGH$ be squares such that $E$ lies on $\overline{AB}$, $F$ lies on $\overline{BC}$, $G$ lies on $\overline{CD}$, and $H$ lies on $\overline{AD}$. If the area of $EFGH$ is $\frac{5}{9}$ of the area of $ABCD$ and $AE \geq BE$, what is $\frac{AE}{BE}$? %Should we provide the diagram on the contest?
\end{problem}
